...
and instead does an -preserving resize followed by random crop during
...
def preprocess_image(image_buffer, bbox, output_height, output_width,
  ...
  Args:
    ...
    is_training: `True` if we're preprocessing the image for training and
      `False` otherwise.
    autoaugment_type: string type. see https://arxiv.org/abs/1805.09501.
  ...
  if is_training:
    ...
    if autoaugment_type:
      #According to https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/data/ops/dataset_ops.py#L1177,
      #a dataset pipe line allow you not to convert tensor to numpy.
      #TODO: use tf.py_function...
      #image = apply_autoaug(image, autoaugment_type)
      image = image
  else:
